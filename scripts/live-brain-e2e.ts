...
async function main() {
  ...
  const seller = await post("http://localhost:3001/offers", {
    ...
    agentId: "2", wallet: "0xSELLERLIVE1234", pulseMinutes: 145,
  });
  ...
  const buyer = await post("http://localhost:3001/intents", {
    ...
    requirements: { cuda: "13.0", gpu: "H200" },
    agentRegistry: "eip155:84532:0x8004A818BFB912233c491871b3d84c89A494BD9e",
    agentId: "1", wallet: "0xBUYERLIVE5678",
  });
  ...
  const mk = (role: "buyer" | "seller", price: number, wssUrl: string): AgentDeps => ({
    wsUrl: wssUrl,
    role,
    identity: { agentRegistry: "eip155:84532:0x8004A818BFB912233c491871b3d84c89A494BD9e", agentId: role === "buyer" ? "1" : "2", wallet: role === "buyer" ? "0xBUYERLIVE5678" : "0xSELLERLIVE1234" },
