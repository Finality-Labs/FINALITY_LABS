...
import { erc8004RegisterAgentAction, erc8004GiveFeedbackAction, erc8004GetReputationAction, } from "@goatnetwork/agentkit/plugins";
...
export function buildLiveCtx() {
    ...
    return {
        ...
        wallet,
        pc,
        register: erc8004RegisterAgentAction(wallet),
        giveFeedback: erc8004GiveFeedbackAction(wallet),
        getReputation: erc8004GetReputationAction(wallet),
    };
}
